...
- **Identity before market data:** when the request names a crypto asset or
  ...
  market/news/trading consumer MUST be in separate assistant
  tool-call turns;
...
- **Crypto research flow:** for Bitcoin, Ethereum, Solana, XRP, Dogecoin, or
  ...
  research/news and, when useful, `sentiment(command="fear_greed_index")`
  for crypto sentiment.
- **Leveraged signal requests:** treat leverage and account size as risk-sizing
  inputs, not price evidence. If asked for a $10 trade with 50x leverage, compute
  notional as a derived value and explain the approximate liquidation/risk
  math clearly. Do not refuse just because the user asks for leverage.

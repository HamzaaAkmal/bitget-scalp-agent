...
| `get_block_trades` | Block-trade records | None* |
...
| `web_search` | Search and synthesize web research via Exa | EXA_API_KEY |
| `read_url` | Read web pages through Exa Contents | EXA_API_KEY |
